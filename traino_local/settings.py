...
STATICFILES_DIRS = [
    ...
    ),  # Add this line to include your `staticfiles` folder
]
...
EMAIL_USE_TLS = True
EMAIL_HOST = (
    "email-smtp.us-east-1.amazonaws.com"  # Replace {region} with your AWS SES region
)
EMAIL_PORT = 587  # 25, 587 or 2587
EMAIL_HOST_USER = "AKIAVIMMZLH3BTHFTKMK"  # SES SMTP username
EMAIL_HOST_PASSWORD = (
    "BDsJw26hIA6Bm6QBX7xk+vQdAc1ZODMOYtpADd4HDUKv"  # SES SMTP password
)
DEFAULT_FROM_EMAIL = "no-reply@traino.ai"
