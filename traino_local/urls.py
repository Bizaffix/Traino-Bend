...
from documents.views import generateDocumentSummary, generateDocumentKeypoints, generateDocumentQuiz, attemptQuiz, publishDocument
...
urlpatterns = [
    ...
    path('publishDocument/<int:document_id>', publishDocument),
