...
from .models import CustomUser, CustomCompanyUser, CompanyTeam, Departments , CustomCompanyTeamUser
...
class CustomCompanyTeamMembers(UserAdmin):
    add_form = CompanyUserCreationForm
    form = CompanyUserChangeForm
...
admin.site.register(CustomCompanyTeamUser, CustomCompanyTeamMembers)
