    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule_frequency', django_enum_choices.fields.EnumChoiceField(choice_builder=django_enum_choices.choice_builders.value_value, choices=[('daily', 'daily'), ('3_days_a_week', '3_days_a_week'), ('weekly', 'weekly'), ('monthly', 'monthly')], enum_class=departments.models.Schedule_Types, max_length=13)),
