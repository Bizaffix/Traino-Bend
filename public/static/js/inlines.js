...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        const addInlineClickHandler = function(e) {
            ...
            // select firs answer option
            $("#id_quizquestions_set-"+(nextIndex - 1)+"-option_1_option").prop( "checked", true );
            $("#id_quizquestions_set-"+(nextIndex - 1)+"-answer").val(0);
        };
    ...
    $(document).ready(function() {
        $(".js-inline-admin-formset").each(function() {
            ...
            case "stacked":
                ...
                break;
            case "tabular":
                selector = inlineOptions.name + "-group .tabular.inline-related fieldset:first > div.form-row";
